...
class PerfectNumbersTest extends FunSuite with Matchers {
  ...
  test("Aliquot sum - perfect") {
    PerfectNumbers.aliquotSum(6) should be(6)
    PerfectNumbers.aliquotSum(28) should be(28)
  }

  test("Aliquot sum - abundant") {
    PerfectNumbers.aliquotSum(12) should be(16)
    PerfectNumbers.aliquotSum(24) should be(36)
  }

  test("Aliquot sum - defecient") {
    PerfectNumbers.aliquotSum(8) should be(7)
    PerfectNumbers.aliquotSum(4) should be(3)
  }

  test("Aliquot sum - prime") {
    PerfectNumbers.aliquotSum(11) should be(1)
  }
}
